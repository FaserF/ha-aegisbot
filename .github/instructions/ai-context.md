# AI Context & Instructions for ha-aegisbot

## 🧬 Project DNA
**Repository:** `ha-aegisbot`
**Type:** Home Assistant Custom Integration
**Domain:** `aegisbot`
**Description:** A professional, modern Home Assistant integration for **AegisBot** — the advanced Telegram (and Messenger) group defender. Monitor group health, track moderation stats, and manage security protocols directly from your Home Assistant dashboard.
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/aegisbot/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
